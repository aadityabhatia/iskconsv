...
public class ExternalLinksPopup extends PopupPanel implements ClickHandler
{
	public static final ExternalLinksPopup instance = new ExternalLinksPopup();

	private TextBox emailTextBox;

	public ExternalLinksPopup()
	{
